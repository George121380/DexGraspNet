...
def _save_overview(model: torch.nn.Module, loader: DataLoader, device: torch.device,
    ...
    """
    Paginate overview into multiple HTML pages, each containing up to `page_size` samples.
    Writes overview_index.html linking to overview_page_XXXX.html files.
    """
    os.makedirs(out_dir, exist_ok=True)
